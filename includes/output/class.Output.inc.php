...
//        $this->_checkConfig();
    ...
    {
        if (!is_readable(APP_ROOT.'/read_config.php')) {
            $this->error->addError('file_exists(read_config.php)', 'read_config.php does not exist or is not readable by the webserver in the phpsysinfo directory.');
        } else {
